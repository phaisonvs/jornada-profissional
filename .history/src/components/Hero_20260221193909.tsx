...
const ANGLE_STEP_MOBILE = 52;
const ANGLE_STEP_DESKTOP = 40;
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      const run = () => {
        ...
        const progressVal = easeOutExpo(t);
    ...
    <section className="min-h-[90dvh] md:min-h-[82vh] flex flex-col justify-center pt-24 pb-10 md:pt-20 md:pb-12 px-4 md:px-6">
      ...
      >
        ...
        <div className="relative w-full flex justify-center">
          <div className="mt-2 select-none overflow-visible w-full max-w-[86%] md:max-w-[70%] relative">
            <div
              ref={containerRef}
                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          WebkitFilter: isActive ? 'none' : 'blur(0.5px)',
                        }}
                      >
                        ...
                        <div
                          ...
                          } ${isIntro ? 'text-muted-foreground font-normal text-base md:text-lg' : ''}`}
                        >
                          {valueText}
                        </div>
                      </div>
            ...
            <div className="relative z-10 flex justify-center mt-8 md:mt-10 pb-1">
              <button
                onClick={() => document.getElementById('objetivos-techlead')?.scrollIntoView({ behavior: 'smooth' })}
