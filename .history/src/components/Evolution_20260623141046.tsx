...
const steps = [
  ...
  },
  {
    ...
    text: "Espero evol para uma atuação como Tech Lead, ampliando meu escopo técnico para além do e-commerce e aplicando linguagens e competências que venho conquistado com formações.",
  },
];
