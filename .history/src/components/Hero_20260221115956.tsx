...
const Hero = () => {
  ...
  return (
    <section className="min-h-[100dvh] md:min-h-0 flex flex-col justify-center md:justify-start pt-24 pb-10 md:pt-24 md:pb-16 px-4 md:px-6">
      <div
      ...
      >
        ...
        <div className="mt-auto w-full">
          ...
          <div className="md:hidden mt-12 select-none overflow-visible" style={{ position: 'relative' }}>
            <div
              ref={containerRef}
              style={{
                position: 'relative',
            ...
            <button
              type="button"
              onClick={() => document.querySelector('#tldr')?.scrollIntoView({ behavior: 'smooth' })}
              className="md:hidden flex items-center justify-center w-12 h-12 mx-auto mt-8 rounded-full border border-border bg-card/80 hover:bg-primary/10 hover:border-primary/30 transition-all duration-300"
