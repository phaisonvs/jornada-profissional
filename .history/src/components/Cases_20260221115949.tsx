...
>
      ...
      <div className="relative" onMouseEnter={() => setIsPaused(true)} onMouseLeave={() => setIsPaused(false)}>
        <div
          className="absolute left-0 top-0 bottom-0 z-10 pointer-events-none w-24 md:w-[420px]"
          style={{
            background: 'linear-gradient(to right, hsl(var(--secondary)) 0%, hsl(var(--secondary) / 0.9) 15%, hsl(var(--secondary) / 0.6) 35%, hsl(var(--secondary) / 0.25) 55%, transparent 100%)',
          }}
        />
        <div
          className="absolute right-0 top-0 bottom-0 z-10 pointer-events-none w-24 md:w-[420px]"
          style={{
            background: 'linear-gradient(to left, hsl(var(--secondary)) 0%, hsl(var(--secondary) / 0.9) 15%, hsl(var(--secondary) / 0.6) 35%, hsl(var(--secondary) / 0.25) 55%, transparent 100%)',
          }}
        />
