...
const Hero = () => {
  ...
  return (
    <section className="flex flex-col md:justify-center pt-20 pb-10 md:pt-24 md:pb-16 px-4 md:px-6">
      <div
      ...
      >
        ...
        >
          <h1 className="text-xl md:text-3xl lg:text-4xl font-semibold text-foreground leading-tight mb-3 md:mb-4">
