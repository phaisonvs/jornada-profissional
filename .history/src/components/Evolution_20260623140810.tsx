...
const steps = [
  ...
  },
  {
    ...
    text: "Nosso time sempre enfrentou desafios técnicos e funcionais e para tirar evoluções do papel, passei a atuar diretamente com front-end, back-end, APIs, tracking, integrações e sustentação técnica.",
  },
  {
    year: "2024",
    icon: Users,
