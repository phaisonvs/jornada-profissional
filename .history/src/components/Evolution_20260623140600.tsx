...
const steps = [
  ...
  },
  {
    ...
    icon: Layout,
    title: "UX/UI",
    text: "A oportunidade em UX/UI se concretizou quando me posicionei buscando ter mais entendimento e visibilidade do meu trabalho, apartir disso, apliquei mais profundidade em jornadas, interfaces, usabilidade e experiência digital.",
  },
  {
    year: "2022",
    icon: Eye,
