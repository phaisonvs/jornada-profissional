...
const stats: StatItem[] = [
  ...
  },
  {
    ...
    popup: {
      ...
      summary:
        "Atuei em +40 entregas que exigiam conexão entre experiência, tecnologia, regra de negócio e operação.",
      deliveries: [
  ...
  },
  {
    ...
    popup: {
      ...
      deliveries: [
        "Implementei correções advindas de erros de integrações de código por leitura errada de scripts, bem como interfaces, validações, estados de tela e comportamentos responsivos.",
        ...
        "Validei dataLayer, eventos e comportamento, bem como implementação dos meus próprios testes A/B.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    popup: {
      ...
      deliveries: [
        "Publiquei LPs, hotsites e fluxos em Salesforce, Wake, Sharp e domínios próprios.",
